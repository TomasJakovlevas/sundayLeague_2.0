...
export default function Page() {
  return (
    <>
      <main className='flex flex-col bg-accent-500 min-h-screen md:flex md:justify-center xl:px-20 xl:pt-20'>
        <div className='mx-5 mt-[51px]  flex flex-col items-center flex-1 md:justify-center md:flex-row md:mt-0 gap-8 md:gap-[50px] xl:gap-[100px] xl:mt-0 xl:flex-nowrap 2xl:gap-[150px] transition-all'>
        ...
        <div className='m-5 text-primary-500'>
          <Footer />
        </div>
      </main>
    </>
