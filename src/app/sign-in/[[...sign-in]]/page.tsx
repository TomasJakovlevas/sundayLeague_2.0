...
export default function Page() {
  return (
    <main className='flex flex-col bg-accent-500 min-h-screen xl:p-20 xl:flex xl:justify-center'>
      <div className='px-5 mt-32 flex flex-wrap-reverse justify-center items-center gap-[20px] xl:gap-[100px] xl:mt-0 xl:flex-nowrap 2xl:gap-[200px] transition-all'>
        <div className='flex justify-end xl:w-1/2'>
          <div className='hidden h-[750px] w-[750px] relative '>
            <Image
        ...
        <div className='flex flex-col gap-5 xl:gap-6 xl:w-1/2'>
          <div className='text-primary-500 xl:w-full xl:w-fit xl:px-[27px]'>
            <h1 className='text-3xl mb-8 font-black font-bungy flex flex-wrap gap-2 xl:text-8xl xl:mb-8 xl:flex-col xl:leading-none'>
              <span>SUNDAY</span>
              <span>LEAGUE</span>
            </h1>
